...
class ClinicalCaseViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        radiation_therapy_type_filter = self.request.query_params.get("radiation_therapy_type")
        ...
        number_of_fractions_filter = self.request.query_params.get("number_of_fractions")
        ...
        if radiation_therapy_type_filter:
            ...
            queryset = queryset.filter(radiation_therapy_type__in=radiation_therapy_type_list)
        if tumor_filter:
...
class ModelStructureViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (permissions.IsAuthenticated,)
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['model_name','parameter',]
    search_fields = ['model_name__name','model_name__full_name','model_name__model_type',
                     'parameter__full_name','parameter__name','parameter__unit__name','parameter__unit__full_name',
                     'note',]  
    ordering_fields = ['model_name','parameter', 'note',] 
    ordering = ['model_name']  
...
class ResultViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['model_structure__model_name__name','model_structure__model_name__full_name','model_structure__model_name__model_type',
                     'model_structure__parameter__full_name','model_structure__parameter__name','model_structure__parameter__unit__name','model_structure__parameter__unit__full_name',
                     "value", "upper_value", "lower_value",'note',]  
    ordering_fields = ["model_structure", "value", "upper_value", "lower_value", 'note',] 
...
class DataSetViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['result__model_structure__model_name__name', 'source__name', 'note'] 
    ordering_fields = ['result', 'сlinical_сase', 'source', 'note']
    ordering = ['result']
...
#     filterset_fields = {
#         'result__model_structure__model_name__name': ['exact', 'icontains'],  
#         'сlinical_сase__quantity': ['exact'],  
#         'source__name': ['exact', 'icontains'],  
#         'note': ['exact', 'icontains'], 
#     }

#     search_fields = ['result__model_structure__model_name__name', 'source__name', 'note'] 
#     ordering_fields = ['result__model_structure__model_name__name', 'сlinical_сase__quantity', 'source__name', 'note']
#     ordering = ['result__model_structure__model_name__name']
